...
## What's Difference on this Driver?
 - CTUSBAud Kernel Driver
   ...
   - The Sound Blaster X4 originally used a kernel driver called "CTUSBAud/CTUSBa64" as of driver version '2.00.02.10', but newer versions use Microsoft's default kernel driver, "usbaudio2.sys". This causes annoying problems on some systems.
   - Therefore, this driver is based on driver version '3.06.03.00' and is a modded driver designed to operate in the same way as '2.00.02.10'.
   - While many Sound Blaster X4 users have found that using the '2.00.02.10' driver version has resolved an annoying issue, it may still cause clicks and pops on some systems. i recommend using the appropriate driver for your situation.
